export const Dots = ({ fill }: { fill?: string}) => {
    return (
        <svg className={`fill-white ${fill}`} enableBackground="new 0 0 32 32" id="Glyph" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
