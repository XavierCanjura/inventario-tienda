...
export const SideNav = ({ toggleShow, show }: { show: boolean, toggleShow: () => void }) => {
    ...
    return (
        <div className={`${ show ? 'translate-x-[0px] w-[75vw] md:min-w-[300px] md:w-[300px]' : 'translate-x-[-75vw] md:translate-x-[-300px] w-0' } absolute z-[999] bg-white md:relative h-dvh flex flex-col border-l-0 border-t-0 rounded-br-[20px] shadow-lg transition-all duration-500 ease-in-out`}>
            <div className="w-full h-[200px] bg-slate-600 flex px-2 pt-3">
